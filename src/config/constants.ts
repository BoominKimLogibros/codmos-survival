...
export const ARENA_WALL_INSET = WORLD_SIZE / 8;
export const ARENA_PLAYABLE_HALF_SIZE = WORLD_SIZE / 2 - ARENA_WALL_INSET;
...
export const ADAPTIVE_FAST_WINDOWS_PER_EXTRA_BOSS = 2;
export const ADAPTIVE_MAX_CONCURRENT_BOSSES = 5;
...
export const RUNE_EMERGE_DELAY_MS = 3000;
export const RUNE_EMERGE_DURATION_MS = 240;
export const RUNE_EMERGE_START_OFFSET_Y = 18;
